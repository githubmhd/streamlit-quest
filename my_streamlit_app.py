...
option = st.radio(label= "veuillez séléctionner un continent.",
...
ax4.set_title("La consomation en fonction du poids par continent", fontsize=20)
...
ax4.set_xlabel("poids (lbs)", fontsize=20)
ax4.set_ylabel("miles par gallon", fontsize=20)
st.pyplot(ax1.figure)
